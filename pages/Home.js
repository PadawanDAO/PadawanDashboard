				...
				<div className="pl-8 pr-8">
					...
					<div className="pb-4">
						...
						<p>
							...
							protocol. This is some more description on me, as aleem
							refused to grab some lorem ipsum thinking hed do a legit desc,
							but didnt{" "}
						</p>
					</div>
...
function List() {
	return (
		<div className="grid grid-cols-1 lg:grid-cols-3  tablet:grid-cols-2 ">
			<Home />
			<Home />
			<Home />
		</div>
